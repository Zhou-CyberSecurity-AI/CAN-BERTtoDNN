...
def main(args):
    ...
    # exit(0)
    ckpt_dict = torch.load('./save/pretrain/train/DoS-LSTM-Teacher-01/best.pth.tar', map_location=device)
    ...
    model = SimpleLSTM(input_dim=args.input_dim, hidden_dim=args.hidden_size, output_dim=args.output_dim, dropout_rate=args.drop_prob)
    ...
    trainDataset, devDataset, testDataset = utils.getDataset(args.load_dos_dataset)
