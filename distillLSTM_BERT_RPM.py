...
def main(args):
    ...
    # exit(0)
    ckpt_dict = torch.load('./save/pretrain/train/RPM-LSTM-Teacher-01/best.pth.tar', map_location=device)
    ...
    trainDataset, devDataset, testDataset = utils.getDataset(args.load_rpm_dataset)
