...
def main(args):
    ...
    # exit(0)
    ckpt_dict = torch.load('./save/pretrain/train/Gear-LSTM-Teacher-01/best.pth.tar', map_location=device)
    ...
    # LSTM
    model = SimpleLSTM(input_dim=args.input_dim, hidden_dim=args.hidden_size, output_dim=args.output_dim, dropout=args.drop_prob, n_layers=2)
    ...
    trainDataset, devDataset, testDataset = utils.getDataset(args.load_gear_dataset)
